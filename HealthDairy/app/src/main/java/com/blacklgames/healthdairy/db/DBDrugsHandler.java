...
public class DBDrugsHandler implements IDBDrugsHandler
{
    ...
    public void addDrug(Drug drug)
    {
        ...
        values.put(KEY_DRUG_COUNT, drug.get_duration());
        values.put(KEY_DRUG_PERIOD, drug.get_duration_period());
    ...
    public Drug getDrug(int id)
    {
        ...
        drug.set_duration(cursor.getInt(eDrugKeyPos.K_DRUG_COUNT.ordinal()));
        drug.set_duration_period(cursor.getInt(eDrugKeyPos.K_DRUG_PERIOD.ordinal()));
